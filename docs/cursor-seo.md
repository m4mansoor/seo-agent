...
Free, 25 sites, links built in your own browser: `pip install seo-agent && playwright install chromium`, then in Cursor, Settings, MCP, Add new MCP server with command `seo-agent`.
